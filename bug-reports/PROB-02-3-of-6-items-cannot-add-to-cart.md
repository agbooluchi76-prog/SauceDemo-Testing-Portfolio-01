# PROB-02: 3 Out of 6 Items Cannot Be Added to Cart
...
When attempting to add all 6 products to the cart as problem_user, only 3 items can be successfully added. The remaining 3 items cannot be added to the cart.
